...
New Words: [это (ср. р.), эта (ж. р.), этот (муж. р.), там тот (муж. р.), там та (ж. р.), я есмь, ты еси, он/она/оно есть, мы есмы, вы есте, они суть, я, ты, он, она, оно, мы, вы, они (муж. р.), они (жен. р.), человек, женщина, мужчина, дитя, друг, сестра, родитель, дом, город, день, тоже, кто]
Phrases: [
    "Я есмь мудрый.",
    "Это моя сестра.",
    "Она много мудра",
...
New Words: [приветствие, здоровый/привет, беседа, утро, вечер, день, ночь, спасибо, пардон, извини, добрый, лучше, можно, жаль, так, что, нет, да, может быть, давай]
Phrases: [
    "Доброе утро!",
    "Добрый вечер!",
    "Добрый день!",
...
New Words: [брат, дед, бабка, тётка, внук, внучка, матка, отец, родина, сын, дочка, дядя (по отцу), говорит, идёт (пешком), идём (пешком), живёт]
Phrases: [
    "Он есть моим братом.",
    "Он есть твоим отцом",
    "Она идёт с маткою.",
...
Phrases: [
    ...
    "Груша есть вкусная.",
    "Банан есть жёлтый.",
    "Апельсины суть сладкие.",
    "Вишня есть кислая.",
    "Ягода есть малая и вкусная.",
    "Виноград растёт на винограднике.",
    "Слива есть тёмная.",
    "Лимон есть кислый и жёлтый.",
    "Дыня есть большая и сладкая.",
...
Phrases: [
    "Это моя школа.",
    "Она есть учительницею.",
    "Он есть учеником.",
    "Книга есть на столе.",
    "Я имею задание.",
    "Тушь есть ещё мокрая.",
    "Бумага есть белая.",
    "Этот предмет то математика.",
    "Этот метод есть добрый.",
    "Ученик имеет книгу.",
    "Это есть мой стол.",
    "Моя записная книжка есть полна записей с пером",
    "Пишу на бумаге пером.",
    "Школа есть в центре.",
    "Мы пишем задание.",
    "Учитель говорит со студентами.",
    "Она имеет много заданий.",
    "Я быстро пишу этим пером.",
    "Предмет есть сложный.",
    "Книга есть новая.",
    "Он есть моим учителем."
]
...
Phrases: [
    ...
    "Эта линия есть длинная.",
    "Это есть моя форма.",
    "Линия есть равная.",
    "Точка то малый пункт.",
    "Видим контур квадрата.",
    "Фигура есть комплексная.",
    ...
    "Это есть простой треугольник.",
    "Он рисует фигуры на бумаге.",
    "Форма есть интересная.",
...
Phrases: [
    "Нож лежит на столе.",
    "Вилка есть серебряная.",
    "Ложка есть в соли.",
    "Тарелка есть полна еды.",
    ...
    "Нож есть острый.",
    "Вилки и ножи суть на столе.",
    "Ложка есть полна перца.",
    "Тарелка лежит на полу.",
    "Консерва есть пустая.",
...
Phrases: [
    ...
    "Потом налево.",
    "Иди прямо до моста.",
    "Проспект есть близко площади/рынка.",
    ...
    "Площадь/Рынок есть далеко от отеля.",
...
New Words: [время, минута, секунда, час (длительность), сегодня, был, была, было, были, шёл, шла, шло, шли, вчера, завтра, вечер, полночь, сколько, спать (спит), длиться]
Phrases: [
...
Phrases: [
    ...
    "Как они были бы не ленивы, то мы были бы им помогали.",
    "Она есть добрая и искренняя.",
    "Он есть сильный, но смелый.",
    "Дети суть мудрые для их возраста.",
    "Как вы не были бы слабы, то вы были бы работали.",
    "Злые слова болят.",
    "Глупый не учится.",
...
Phrases: [
    ...
    "Её волосы суть светлые и долгие.",
    "А его красивые волосы суть тёмные как ночь."
]